...
static void combine_hashes(uint32_t *out, uint32_t *hash1, uint32_t *hash2,
                           uint32_t *hash3, uint32_t *hash4) {
...
void heavycoin_hash(unsigned char *output, const unsigned char *input,
                    int len) {

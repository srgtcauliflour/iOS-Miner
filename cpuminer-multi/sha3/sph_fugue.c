...
static const sph_u32 IV224[] = {SPH_C32(0xf4c9120d), SPH_C32(0x6286f757),
                                SPH_C32(0xee39e01c), SPH_C32(0xe074e3cb),
                                SPH_C32(0xa1127c62), SPH_C32(0x9a43d215),
                                SPH_C32(0xbd8d679a)};

static const sph_u32 IV256[] = {SPH_C32(0xe952bdde), SPH_C32(0x6671135f),
                                SPH_C32(0xe0d4f668), SPH_C32(0xd2b0b594),
                                SPH_C32(0xf96c621d), SPH_C32(0xfbf929de),
...
static void fugue_init(sph_fugue_context *sc, size_t z_len, const sph_u32 *iv,
                       size_t iv_len) {
  size_t u;
...
static void fugue2_close(sph_fugue_context *sc, unsigned ub, unsigned n,
...
static void fugue3_close(sph_fugue_context *sc, unsigned ub, unsigned n,
                         void *dst) {
  int i;
...
static void fugue4_close(sph_fugue_context *sc, unsigned ub, unsigned n,
                         void *dst) {
  int i;
...
void sph_fugue224_init(void *cc) { fugue_init(cc, 23, IV224, 7); }

void sph_fugue224(void *cc, const void *data, size_t len) {
  fugue2_core(cc, data, len);
}

void sph_fugue224_close(void *cc, void *dst) { fugue2_close(cc, 0, 0, dst, 7); }

void sph_fugue224_addbits_and_close(void *cc, unsigned ub, unsigned n,
                                    void *dst) {
  fugue2_close(cc, ub, n, dst, 7);
}

void sph_fugue256_init(void *cc) { fugue_init(cc, 22, IV256, 8); }

void sph_fugue256(void *cc, const void *data, size_t len) {
  fugue2_core(cc, data, len);
}

void sph_fugue256_close(void *cc, void *dst) { fugue2_close(cc, 0, 0, dst, 8); }

void sph_fugue256_addbits_and_close(void *cc, unsigned ub, unsigned n,
                                    void *dst) {
  fugue2_close(cc, ub, n, dst, 8);
}

void sph_fugue384_init(void *cc) { fugue_init(cc, 24, IV384, 12); }

void sph_fugue384(void *cc, const void *data, size_t len) {
  fugue3_core(cc, data, len);
}

void sph_fugue384_close(void *cc, void *dst) { fugue3_close(cc, 0, 0, dst); }

void sph_fugue384_addbits_and_close(void *cc, unsigned ub, unsigned n,
                                    void *dst) {
  fugue3_close(cc, ub, n, dst);
}

void sph_fugue512_init(void *cc) { fugue_init(cc, 20, IV512, 16); }

void sph_fugue512(void *cc, const void *data, size_t len) {
  fugue4_core(cc, data, len);
}

void sph_fugue512_close(void *cc, void *dst) { fugue4_close(cc, 0, 0, dst); }

void sph_fugue512_addbits_and_close(void *cc, unsigned ub, unsigned n,
                                    void *dst) {

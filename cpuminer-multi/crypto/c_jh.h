/*This program gives the 64-bit optimized bitslice implementation of JH using
   ANSI C
   ...
   1) 45.8 cycles/byte   compiler: Intel C++ Compiler 11.1   compilation option:
   icc -O2 2) 56.8 cycles/byte   compiler: gcc 4.4.3                 compilation
   option: gcc -O3

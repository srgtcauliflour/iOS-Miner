...
const uint8_t indices_cyclic[15] = {0, 1, 2, 3, 4, 5, 6, 7,
                                    0, 1, 2, 3, 4, 5, 6};
...
static void Update(groestlHashState *ctx, const BitSequence *input,
...
/* hash bit sequence */
void groestl(const BitSequence *data, DataLength databitlen,
             BitSequence *hashval) {

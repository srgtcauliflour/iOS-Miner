...
static void salsa_core_basic(uint32_t state[16]) {
  size_t rounds = 8;
...
#define quarter(a, b, c, d)                                                    \
  ...
  for (; rounds; rounds -= 2) {
    quarter(x0, x4, x8, x12) quarter(x5, x9, x13, x1) quarter(x10, x14, x2, x6)
        quarter(x15, x3, x7, x11) quarter(x0, x1, x2, x3)
            quarter(x5, x6, x7, x4) quarter(x10, x11, x8, x9)

...
static void chacha_core_basic(uint32_t state[16]) {
  size_t rounds = 8;
...
#define quarter(a, b, c, d)                                                    \
  ...
  for (; rounds; rounds -= 2) {
    quarter(x0, x4, x8, x12) quarter(x1, x5, x9, x13) quarter(x2, x6, x10, x14)
        quarter(x3, x7, x11, x15) quarter(x0, x5, x10, x15)
            quarter(x1, x6, x11, x12) quarter(x2, x7, x8, x13)

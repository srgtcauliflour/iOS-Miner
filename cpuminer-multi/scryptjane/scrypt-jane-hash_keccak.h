...
#define SCRYPT_KECCAK_C                                                        \
  (SCRYPT_HASH_DIGEST_SIZE * 8 * 2) /* 256=512, 512=1024 */
#define SCRYPT_KECCAK_R                                                        \
  (SCRYPT_KECCAK_F - SCRYPT_KECCAK_C) /* 256=1088, 512=576 */
...
static void scrypt_hash_init(scrypt_hash_state *S) { memset(S, 0, sizeof(*S)); }

static void scrypt_hash_update(scrypt_hash_state *S, const uint8_t *in,
                               size_t inlen) {
  size_t want;
...
static void scrypt_hash_finish(scrypt_hash_state *S, uint8_t *hash) {
  ...
  memset(S->buffer + (S->leftover + 1), 0,
         SCRYPT_HASH_BLOCK_SIZE - (S->leftover + 1));
...
static const uint8_t scrypt_test_hash_expected[SCRYPT_HASH_DIGEST_SIZE] = {
    0x26, 0xb7, 0x10, 0xb3, 0x66, 0xb1, 0xd1, 0xb1, 0x25, 0xfc, 0x3e,
    0xe3, 0x1e, 0x33, 0x1d, 0x19, 0x94, 0xaa, 0x63, 0x7a, 0xd5, 0x77,
    0x29, 0xb4, 0x27, 0xe9, 0xe0, 0xf4, 0x19, 0xba, 0x68, 0xea,
};
#else
static const uint8_t scrypt_test_hash_expected[SCRYPT_HASH_DIGEST_SIZE] = {
    0x17, 0xc7, 0x8c, 0xa0, 0xd9, 0x08, 0x1d, 0xba, 0x8a, 0xc8, 0x3e,
    0x07, 0x90, 0xda, 0x91, 0x88, 0x25, 0xbd, 0xd3, 0xf8, 0x78, 0x4a,
    0x8d, 0x5e, 0xe4, 0x96, 0x9c, 0x01, 0xf3, 0xeb, 0xdc, 0x12, 0xea,
    0x35, 0x57, 0xba, 0x94, 0xb8, 0xe9, 0xb9, 0x27, 0x45, 0x0a, 0x48,
    0x5c, 0x3d, 0x69, 0xf0, 0xdb, 0x22, 0x38, 0xb5, 0x52, 0x22, 0x29,
    0xea, 0x7a, 0xb2, 0xe6, 0x07, 0xaa, 0x37, 0x4d, 0xe6,
};
#endif
